...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/koenigsegg-gemera.jpg":[function(require,module,exports) {
module.exports = "/koenigsegg-gemera.f30d5569.jpg";
...
function css() {
  ...
  return Object.keys(styles).map(function (item) {
...
},{}],"class/blocks.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TextBlock = exports.ColumnsBlock = exports.ImageBlcok = exports.TitleBlock = void 0;
...
var ImageBlcok = /*#__PURE__*/function (_Block2) {
  _inherits(ImageBlcok, _Block2);

  var _super2 = _createSuper(ImageBlcok);

  function ImageBlcok(value, options) {
    _classCallCheck(this, ImageBlcok);

    return _super2.call(this, value, options);
  }

  _createClass(ImageBlcok, [{
    key: "HTML",
    value: function HTML() {
      ...
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" alt=\"").concat(alt, "\" style=\"").concat((0, _utils.css)(is), "\"/>"), styles);
    }
  }]);
...
var _koenigseggGemera = _interopRequireDefault(require("./assets/koenigsegg-gemera.jpg"));

var _blocks = require("./class/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('Конструктор сайтов на vanillaJS', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ImageBlcok(_koenigseggGemera.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
  ...
  alt: 'image'
}), new _blocks.ColumnsBlock(['11111111111', '22222222', 'hfpwehufpfuwipehf'], {
  styles: {
...
exports.model = model;
},{"./assets/koenigsegg-gemera.jpg":"assets/koenigsegg-gemera.jpg","./class/blocks":"class/blocks.js"}],"class/site.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Site, [{
    ...
    value: function render(model) {
      ...
      model.forEach(function (item) {
        _this.selector.insertAdjacentHTML('beforeend', item.HTML());
      });
    }
  }]);
...
exports.Site = Site;
},{}],"class/sidebar.js":[function(require,module,exports) {
"use strict";
...
},{"../utils":"utils.js","./blocks":"class/blocks.js"}],"class/app.js":[function(require,module,exports) {
"use strict";
...
exports.App = App;
},{"./site":"class/site.js","./sidebar":"class/sidebar.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _app = require("./class/app");

require("./styles/style.css");

new _app.App(_model.model);
},{"./model":"model.js","./class/app":"class/app.js","./styles/style.css":"styles/style.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
